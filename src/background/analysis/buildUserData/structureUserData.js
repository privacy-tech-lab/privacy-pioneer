...
async function getWatchlistDict() {
  ...
  for (let key of keyarr) {
    ...
    for (let [t, val] of Object.entries(keywordObject)) {
      ...
      if (t == permissionEnum.location) {
        parseLocationObject(val, user_store_dict, keywordObject.id);
      }
      if (t == "type") {
        ktype = val;
      }
