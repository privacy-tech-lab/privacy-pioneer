...
import { analyticsKeyval, settingsKeyval } from "../../../libs/indexed-db/openDB.js";
...
async function importData() {
  ...
  //This checks to see if the ipinfo generated keywords are up to date with useres current location
