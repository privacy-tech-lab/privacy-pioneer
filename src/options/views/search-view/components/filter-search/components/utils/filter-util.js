...
/**
  ...
  export const filterLabels = (permFilterLabels, companyFilterLabels, defaultLabels, setPlaceholder) => {
    ...
    setPlaceholder(getPlaceholder(runCompanyFilter, companyFilterLabels, permFilterLabels));
   ...
   * @returns {string}
   */
export const getPlaceholder = (hasCompanyFilter = false, companyFilter, permFilter) => {
