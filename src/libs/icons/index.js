...
export const Moon = ({ size }) => (
  <svg height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 19.6784C17.9029 17.5805 16.4748 14.9081 15.896 11.9989C15.3173 9.08963 15.6139 6.07411 16.7483 3.33337C13.5138 3.97013 10.5427 5.55723 8.21499 7.89171C1.70666 14.4 1.70666 24.9534 8.21499 31.4617C14.725 37.9717 25.2767 37.97 31.7867 31.4617C34.1205 29.1342 35.7075 26.1639 36.345 22.93C33.6042 24.0643 30.5888 24.3607 27.6796 23.782C24.7704 23.2032 22.098 21.7752 20 19.6784V19.6784Z" />
  </svg>
);
