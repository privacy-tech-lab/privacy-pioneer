...
```
If you encounter errors while installing regarding the tensorflow libraries, try running the steps described in [this comment](https://github.com/tensorflow/tfjs/issues/7939#issuecomment-1697183143).
